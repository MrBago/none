...
To exclude streamlines based on a ROI, the \texttt{include} keyword should be set to False. This example shows how one can one can select streamlines that intersect with ROI1 but do not intersect with ROI2.
